...
export default function IdeasModal({ isOpen, onClose }: IdeasModalProps) {
  ...
  return (
    <div
      className='fixed inset-0 bg-black/50 grid place-items-center z-[100] p-4 min-h-[100svh]'
      onClick={onClose}
    >
      <div
      ...
      >
        {/* Header */}
        <div className='bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white p-4 sm:p-6 flex justify-between items-center'>
