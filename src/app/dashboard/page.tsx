      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {calendars.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center border-2 border-gray-100">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-3">No calendars yet</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {calendars.map((calendar: {
              ...
              >
                <h3 className="text-xl font-bold text-gray-800 mb-2">{calendar.title}</h3>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="w-24 bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${(calendar._count.entries / 25) * 100}%` }}
                    />
                  </div>
                </div>
                ...
                <div className="mt-3 text-xs text-gray-500 text-center">
                  Share: {typeof window !== 'undefined' ? window.location.origin : ''}/share/{calendar.shareId}
                </div>
              </div>
            ))}
          </div>
