              ...
              <div className='space-y-4'>
                <div className='bg-red-50 border-l-4 border-red-500 p-4 rounded'>
                  ...
                  <p className='text-gray-700'>
                    Click &ldquo;Create New Calendar&rdquo; and give it a
                    meaningful title like &ldquo;Christmas 2024 for
                    Sarah&rdquo;.
                  </p>
                </div>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <ol className='list-decimal list-inside space-y-2 text-gray-700 ml-4'>
                    ...
                    <li>
                      Right-click the uploaded image and select &ldquo;Copy
                      image address&rdquo;
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ol className='list-decimal list-inside space-y-2 text-gray-700 ml-4'>
                    ...
                    <li>
                      Click the image and copy the &ldquo;Secure URL&rdquo;
                    </li>
                ...
                <div>
                  ...
                  <ol className='list-decimal list-inside space-y-2 text-gray-700 ml-4'>
                    ...
                    <li>
                      Right-click and select &ldquo;Copy image address&rdquo; or
                      &ldquo;Copy image URL&rdquo;
                    </li>
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <ol className='list-decimal list-inside space-y-2 text-gray-700 ml-4'>
                    ...
                    <li>
                      Click the &ldquo;Share&rdquo; button below the video
                    </li>
              ...
              <div className='bg-green-50 border-l-4 border-green-500 p-4 rounded'>
                ...
                <p className='text-green-700'>
                  For best results, make sure your video is set to
                  &ldquo;Public&rdquo; or &ldquo;Unlisted&rdquo; on
                  YouTube/Vimeo so anyone with the calendar link can watch it.
                </p>
              </div>
            </div>
          )}
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <ol className='list-decimal list-inside space-y-2 text-gray-700 ml-4'>
                    <li>
                      Click &ldquo;Add Link&rdquo; button when editing an entry
                    </li>
              ...
              <div className='space-y-4'>
                ...
                <div className='bg-gray-100 p-4 rounded-lg'>
                  ...
                  <p className='text-gray-700'>
                    ...
                    <br />
                    3. Use &ldquo;Owner Preview&rdquo; to test how everything
                    looks together
                  </p>
                </div>
              </div>
